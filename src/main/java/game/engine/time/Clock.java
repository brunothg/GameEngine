...
public class Clock extends Thread {
	...
	private void runNormalFps(long nanosecondsPerFrame, long nanoSystemTime) {
		...
		int waitTimeNanos = (int) (waitTime
				- TimeUtils.NanosecondsOfMilliseconds(waitTimeMillis));
	...
	public synchronized void setFramesPerSecond(int framesPerSecond) {
		...
		this.nanosecondsPerFrame = Math.round(
				(TimeUtils.NANOSECONDS_PER_SECOND / this.framesPerSecond));
	}
