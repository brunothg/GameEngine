...
public class WeakSprite extends DefaultSprite {
	 ...
	 * So consider passing a copy of your original image. Calls to
	 * {@link #getTile(int, int)} will be buffered. So changes maybe ignored or
	 * delayed. Calls to {@link #drawTile(Graphics2D, int, int, int, int)} won't
	 * be buffered.
	 * 
	 * @param image
