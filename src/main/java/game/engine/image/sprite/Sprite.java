...
public interface Sprite {
	 ...
	 * the underlying tile.<br>
	 * Use {@link #drawTile(Graphics2D, int, int, int, int)} for faster action
	...
	/**
	 * Get sub-sprite with given dimension. The returned {@link DerivedSprite}
	 * is linked with this sprite.
	 * 
	 * @param x
