...
public class InternalImage {
	...
	/**
	 * All loaded Images will be released. The next call to load a image will
	 * read it from file not memory.
	 */
	 ...
	 * 
	 * @param path
	 *            path of the image (Identifier)
	 * @param img
	 *            the image that was stored previously at this position
