...
public class InternalImage
{
	 ...
	 * Reloads the images
	 * 
	 * @param s Path to image relative to root folder
	 * @return The image
	...
	public static Image reloadFull(String s) throws IOException
	{
		...
		ret = ImageIO.read(InternalImage.class.getResource(getRootFolder() + s));
	...
	/**
	 * Tries to {@link #fullLoad(String)} the image and resize it. If the loading process fails this
	 * method returns the same as {@link #load(String)} and may be null. <br>
	 * If the resizing succeeds a new instance is returned. Otherwise the return value is a
	 * reference.
	 * 
	 * @param s Path to image relative to root folder
	 ...
	 * 
	 * @param img Path to image relative to root folder
	 */
	public static void freeImage(String img)
	{
