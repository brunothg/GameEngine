...
/**
 *
 * {@link LabelSceneObject} that draws the text on a cached
 * {@link BufferedImage}. This speeds up drawing when animating text, but the
...
public class CachedLabelSceneObject extends LabelSceneObject {
	...
	public void setSize(Size size) {
		boolean redraw = size.getWidth() != getWidth()
