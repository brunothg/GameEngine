 ...
 * resized the backed {@link NinePatchImage} will be repainted.<br>
 * Meanwhile the all drawing will be done with an image cache. Results in improved speed but more
 * memory usage.
 * 
 * @author Marvin Bruns
 *
