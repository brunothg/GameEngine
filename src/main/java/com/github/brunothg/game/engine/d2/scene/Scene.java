...
public interface Scene
{
	 ...
	 * @param width Width of painting area
	 * @param height Height of painting area
	 * @param elapsedTime Time since the last painting
	 */
	public void paintScene(Graphics2D g, int width, int height, long elapsedTime);

	/**
	 * Should return all {@link EventListener}s that this scene want to register.<br>
	 * Some EventListeners maybe unsupported. See {@link JPanel} for additional information.<br>
