...
import com.github.brunothg.game.engine.image.Image;
...
public class DefaultSprite implements Sprite, Image
{
	...
	public void draw(Graphics2D g, int width, int height)
	{
		...
		g.drawImage(image, 0, 0, width, width, 0, 0, image.getWidth(), image.getHeight(), null);
	}
	...
	public BufferedImage getTile(int x, int y)
	{
		...
		BufferedImage tile = image.getSubimage(x * getTileWidth(), y * getTileHeight(), getTileWidth(),
			getTileHeight());
