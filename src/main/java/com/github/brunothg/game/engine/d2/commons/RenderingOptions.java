...
import com.github.brunothg.game.engine.exception.IncompatibleValueException;

/**
 * A class holding several rendering settings, that can be used for configuring {@link Graphics2D}
 * objects. Most methods can be used like a builder class.
 * 
 * @author Marvin Bruns
 *
 */
public class RenderingOptions extends HashMap<RenderingHints.Key, Object>
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(RenderingOptions.class);
	 ...
	 * 
	 * @param g {@link Graphics} object used for initial configuration
	 */
	 ...
	 * 
	 * @param g {@link Graphics2D} used for copying
	...
	public void copyOptionsFrom(Graphics2D g)
	{
		...
		for (java.util.Map.Entry<Object, Object> option : options.entrySet())
		{
			...
			{
				LOG.warn("Could not copy option ({} -> {}). Should be of type {}", key, value,
	...
	{
		for (java.util.Map.Entry<? extends Key, ? extends Object> entry : m.entrySet())
		{
	...
	/**
	 * Set the rendering state for {@link Key}. Only values accepted by this {@link Key} are
	 * allowed.
	 * 
	...
	public Object put(Key key, Object value)
	{
		if (!key.isCompatibleValue(value))
		{
			throw new IncompatibleValueException(
				String.format("For (%s) the value (%s) can not be used. See Key.isCompatibleValue.", key.toString(),
					value.toString()));
		}
	...
	/**
	 * Sets the anti aliasing option. If null is passed, the default behavior will be activated.
	 * 
	...
	/**
	 * Sets the fractional metrics option. If null is passed, the default behavior will be
	 * activated.
	 * 
	 * @param on The fractional metrics status used.
	...
	/**
	 * Sets the stroke control option. If null is passed, the default behavior will be activated. If
	 * true, strokes will be normalized.
	 * 
	 * @param on The stroke control status used.
	...
	/**
	 * Sets the dithering option. If null is passed, the default behavior will be activated.
	 * 
	 * @param on The dithering status used.
	...
	/**
	 * Sets the enhanced color rendering option. If null is passed, the default behavior will be
	 * activated. If true, the color rendering will try to produce the best possible result, but may
	 * be much slower.
	 * 
	 * @param on The enhanced status status used.
	...
	/**
	 * Sets the enhanced rendering option. If null is passed, the default behavior will be
	 * activated. If true, the rendering will try to produce the best possible result, but may be
	 * much slower.
	 * 
	 * @param on The enhanced status status used.
	...
	/**
	 * Sets the enhanced interpolation option. If null is passed, the default behavior will be
	 * activated. If true, the interpolation will try to produce the best possible result, but may
	 * be much slower.
	 * 
	 * @param on The enhanced status status used.
	...
	/**
	 * Sets the enhanced alpha interpolation option. If null is passed, the default behavior will be
	 * activated. If true, the alpha interpolation will try to produce the best possible result, but
	 * may be much slower.
	 * 
	 * @param on The enhanced status status used.
	 ...
	 * 
	 * @param contrast The used contrast level
	...
	public RenderingOptions setTextLcdContrast(int contrast)
	{
		...
		{
			throw new IncompatibleValueException("Contrast level not compatible -> " + contrast);
		}
	...
	/**
	 * Apply this rendering settings to an {@link Graphics} object. Previous options will remain and
	 * aren't overwritten.
	 * 
	 * @param g The {@link Graphics} object used for configuration purpose
	...
	/**
	 * Apply this rendering settings to an {@link Graphics} object. This will try to cast it to a
	 * {@link Graphics2D} object, as only this will support those settings.
	 * 
	 * @param g The {@link Graphics} object used for configuration purpose
	 * @param fullyReplace If true, all options set before will be discarded
	...
	/**
	 * Apply this rendering settings to an {@link Graphics2D} object. Behaves like
	 * {@link Graphics2D#addRenderingHints(java.util.Map)}.
	 * 
	 * @param g The {@link Graphics} object used for configuration purpose
	 * @param fullyReplace If true, all options set before will be discarded
	 */
