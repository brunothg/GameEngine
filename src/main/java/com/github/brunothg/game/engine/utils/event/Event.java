...
public abstract class Event<T>
{
	...
	/**
	 * Get the message string. If it isn't a string, the toString() method will be used.
	 * 
	...
	/**
	 * Test, if this event got handled before. You may ignore this event in this case.
	 * 
	 ...
	 * 
	 * @see #consume()
	 * @param consumer Set the consuming object, so that other handler can react on this
	 */
