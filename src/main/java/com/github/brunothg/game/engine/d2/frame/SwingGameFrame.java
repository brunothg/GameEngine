 ...
 *
 */
public class SwingGameFrame extends JFrame implements Closeable {
	...
	private void setDefaultIcon() {
		try {
			setIconImage(
					ImageIO.read(SwingGameFrame.class.getResource("/com/github/brunothg/game/engine/media/icon.png")));
		} catch (IOException e) {
	 ...
	 * @param innerSize if true the inner size of this frame is set. This is the
	 *                  size inside all decorations.
	 */
