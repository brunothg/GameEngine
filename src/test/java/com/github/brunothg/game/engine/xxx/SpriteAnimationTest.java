...
import com.github.brunothg.game.engine.d2.object.sprite.SpriteSceneObject;
...
import com.github.brunothg.game.engine.image.sprite.WeakSprite;
...
public class SpriteAnimationTest {
	...
	public static void main(String[] args) throws Exception {
		...
		sprite = new WeakSprite(ImageUtils.BufferedImage(InternalImage.load("animatedSprite.png")), 64, 64);
		...
		final SpriteSceneObject animation = new SpriteSceneObject(sprite, TimeUtils.NanosecondsOfMilliseconds(100));
		...
		stage.setMinimumSize(new Dimension(animation.getWidth() + 10, animation.getHeight() + 10));
