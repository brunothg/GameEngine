...
public class SpriteTileTest
{
	...
	public static void main(String[] args)
	{
		...
		Sprite sprite = new WeakSprite(ImageUtils.BufferedImage(InternalImage.load("tile.png")), 32, 32);
		...
		disp1.setLayout(new GridLayout(sprite.getRows(), sprite.getColumns(), 10, 10));
		...
		disp2.setLayout(new GridLayout(sprite2.getRows(), sprite2.getColumns(), 10, 10));
