...
public class StageFPSTest
{
	...
	public static void main(String[] args)
	{
		...
		FPSScene fpsScene = new FPSScene(new Scene()
		{
			...
			private void drawLine(Graphics2D g, int width, int height, long elapsedTime)
			{
				...
				Color c = new Color((int) (rand1 * 255), (int) (rand2 * 255), (int) (rand3 * 255));
				g.setColor(c);

				g.drawLine((int) (width * rand1), (int) (height * rand2), (int) (width * rand3),
					(int) (height * rand4));
			}
